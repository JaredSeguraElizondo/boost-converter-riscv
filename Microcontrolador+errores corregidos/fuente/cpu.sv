...
//   forwarding y deteccion de hazards.
//
...
//   [FIX 5] SubD/SubE: señal explicita de resta para evitar falso sub en I-type
...
//
//   La data_memory y instruction_memory ya NO estan instanciadas aqui.
...
module cpu (
    ...
    output logic [31:0] ProgAddress_o,     // PC -> direccion de ROM
    input  logic [31:0] ProgIn_i,          // Instruccion leida de ROM

    // -- Bus de datos (Harvard -- RAM + perifericos externos) --  [MOD 1]
    output logic [31:0] DataAddress_o,     // Direccion de dato (ALUResultM)
    output logic [31:0] DataOut_o,         // Dato a escribir (WriteDataM)
    input  logic [31:0] DataIn_i,          // Dato leido (del read_mux)
    output logic        we_o               // Write-enable global
);

    // ========================================================================
    // 1. Declaracion de señales internas por etapa
    // ========================================================================
    ...
    logic        SubE;                    // [FIX 5]
    logic        BranchTakenE;            // [FIX 2]
    logic [31:0] JumpTargetE;             // [FIX 3]
    ...
    // Adder para calculo de salto relativo a PC (jal, branches)
