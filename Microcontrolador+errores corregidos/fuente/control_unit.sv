module control_unit (
    ...
    output logic       SubD            // [FIX] Señal explicita de resta
);
    ...
    always_comb begin
        ...
        case (op)
            ...
            7'b0110011: begin // tipo R: add, sub, and, or, xor, sll, srl, sra, slt, sltu
                ...
                // [FIX] Sub se decide aqui, donde funct7 es confiable (R-type)
                SubD = (funct3 == 3'b000 && funct7 == 7'b0100000) ? 1 : 0;

                case (funct3)
                    3'b000: ALUControlD = 3'b000; // add/sub -> ALU usa SubE
