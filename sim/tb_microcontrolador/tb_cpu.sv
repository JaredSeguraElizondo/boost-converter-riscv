// ============================================================================
// tb_cpu_proyecto3.sv
// Testbench del CPU completo (Proyecto 3).
//
// Cambios respecto al TB anterior:
//   - CPU ahora tiene bus Harvard externalizado (ProgAddress/In, Data*)
//   - Se instancian instruction_memory y data_memory externamente
//   - Se agrega un mock de perifericos para simular ADC, GPIO, UART
//   - Se monitorean las escrituras al UART_TX para ver los bytes enviados
// ============================================================================
...
module tb_cpu;
    ...
    // =========================================================================
    // MOCK DE PERIFERICOS
    // Simula respuestas minimas para que el CPU pueda correr el programa
    // completo sin hardware real.
    //
    //   ADC_CTRL  (0x10110): new_data = 1 siempre → CPU sale de poll_adc
    //   ADC_DATA  (0x10114): valor fijo = 2048 (0x800)
    //   GPIO_STAT (0x10130): boton = 1 siempre → CPU intenta enviar por UART
    //   UART_CTRL (0x10040): tx_busy = 0 siempre → CPU no espera
    //   Todo lo demas       : 0
    // =========================================================================
    ...
    // =========================================================================
    // MONITOR DE BUS
    // Imprime las escrituras importantes para verificar que el CPU ejecuta
    // correctamente la inicializacion y el lazo de control.
    // =========================================================================
